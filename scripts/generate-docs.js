    ...
    sections: [
      ...
      // ============ 5. ТЕХНИЧЕСКАЯ ДОКУМЕНТАЦИЯ ============
      {
        children: [
          ...
          spacer(100),
          para("Стек технологий:", "bold"),
          bullet("Next.js 15 (App Router) — серверный рендеринг, API routes"),
          bullet("React 19 — клиентские компоненты"),
          bullet("TypeScript — типизация"),
          bullet("Supabase — база данных (PostgreSQL), аутентификация, storage, RLS"),
          bullet("Tailwind CSS v4 — стилизация"),
          bullet("TipTap.js — WYSIWYG редактор"),
